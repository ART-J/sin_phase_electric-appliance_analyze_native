...
#include <stdio.h>
#include <stdlib.h>
#include <VCU2/vcu2_include/vcu2_fft.h>
#include <VCU2/vcu2_include/vcu2_types.h>
...
void adc1_spectrum_caculate(void)   //频谱计算
{
...
void adc1_harmonic_caculate(void)  //谐波计算
{
    uint16_t i;
...
void adc1_2_phase_caculate(void)  //相位计算
{
    uint16_t i;
...
void adc1_2_power_caculate(void) //功率计算
{
